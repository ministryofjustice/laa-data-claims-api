...
Feature: Amendment gates — field amendability & assessed-claim pricing restriction
  ...
  @DS1767_3
  Scenario: Multiple non-amendable fields are aggregated with other validation messages in the Step 12 response
    ...
    # errors; the unrelated INVALID_FIELD_VALUE is carried on the amendable client_surname.
    ...
    And an unrelated validation collects a validation message with code "INVALID_FIELD_VALUE" for field "client_surname"
    When I submit the amendment and wait for the event service to complete amendment validation
