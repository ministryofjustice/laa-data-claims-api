// Disabled due to no compatible for springboot 4.0 and javers
// see: https://github.com/javers/javers/issues/1465
...
//
/// **
// * An aspect responsible for auditing changes to entities using Javers. This aspect intercepts
// save
...
// This
//   * is run after the successful execution of the save method in any of the classes in the
// specified
...
//  @AfterReturning(
//      pointcut = "execution(*
// uk.gov.justice.laa.dstew.payments.claimsdata.repository.*.save(..))",
//      returning = "result")
...
//   *
//   * @param joinPoint the join point providing reflective access to the intercepted method
//   * @param id Id of the entity being deleted, used to fetch the data to be audited, before it
// gets
//   *     deleted.
//   */
//  @Before(
