 ...
 * handoff (DSTEW-1762).
 *
 * <p>On a successful <b>pricing</b> amendment, {@link #attach} links the FSP-prepared
...
public class AmendmentCalculatedFeeWriter {
  ...
  public void attach(ClaimAmendment amendment, ClaimAmendmentState state) {
    // Links the FSP-prepared calculated-fee row from the state to this amendment, if any.
  }
}
