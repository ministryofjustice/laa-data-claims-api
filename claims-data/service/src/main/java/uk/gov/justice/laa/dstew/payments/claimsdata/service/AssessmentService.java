...
public class AssessmentService {
   ...
   * created assessment for each claim in the submission that has one or more assessments.</p>
   *
   * <p>Claims with no assessments do not contribute to the total. If no assessments exist for any
   * claim in the submission, this method returns {@code null}.</p>
   *
   * @param submissionId the unique identifier of the submission
   * @return the summed assessed total amount for the submission, or {@code null} if no assessments exist
   */
