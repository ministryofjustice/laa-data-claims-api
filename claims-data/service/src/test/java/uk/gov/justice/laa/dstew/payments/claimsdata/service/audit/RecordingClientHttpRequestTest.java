...
public class RecordingClientHttpRequestTest {
    ...
    void capturesWrittenBuffers() {
        RecordingClientHttpRequest request =
                new RecordingClientHttpRequest(HttpMethod.POST, URI.create("http://x/y"), captured::writeBytes);
    ...
    void completesWithoutBody() {
        RecordingClientHttpRequest request =
                new RecordingClientHttpRequest(HttpMethod.GET, URI.create("http://x/y"), captured::writeBytes);
