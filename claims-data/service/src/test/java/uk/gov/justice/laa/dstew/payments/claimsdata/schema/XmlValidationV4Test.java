...
public class XmlValidationV4Test {

  // Path to your XSD
  private static final String XSD_PATH = "src/main/resources/schemas/LSCSMSBulkLoadSchemaV4.xsd";
  ...
  private static Stream<String> validXmlFileNames() {
    return Stream.of(
        ...
        "outcomes_with_inquest_fields.xml");
  }
  ...
  private static Stream<String> invalidXmlFileNames() {
    return Stream.of(
        ...
        "outcomes_with_unsupported_name_v4.xml",
